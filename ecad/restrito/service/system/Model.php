...
error_reporting(0);
	...
	class Model{
		...
		public function __construct(){
			$this->db = new PDO('pgsql:host=ecadmusicas.postgresql.dbaas.com.br;dbname=ecadmusicas', 'ecadmusicas', 'roma@@6458');
			$this->db->exec("SET NAMES 'UTF8'");
		}

		//CONEXÃO PARA INSERÇÃO DE IMAGEM/AUDIO COMO OBJ OID COM PG_CONNECT
		public function connectPG(){
			return pg_connect("host=ecadmusicas.postgresql.dbaas.com.br port=5432 dbname=ecadmusicas user=ecadmusicas password=roma@@6458");
		}
