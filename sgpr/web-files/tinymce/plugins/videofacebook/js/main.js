...
function(t) {
    ...
    function i(t, i) {
        var n = e(t);
        return t && n && (t = "https://www.youtube.com/embed/" + e(t)), t
    }

    function n(t, e, i, n) {
        var o, s;
        return n && (o = 'width="' + e + '" height="' + i + '"', s = t ? '<iframe src="' + n + '" ' + o + ' frameborder="0" allowfullscreen class="embed-responsive-item">&nbsp;</iframe>' : '<div class="youtube"><object type="application/x-shockwave-flash" ' + o + ' data="' + n + '&modestbranding=1"><param name="movie" value="' + n + '&modestbranding=1" /><param name="wmode" value="transparent" /></object></div>'), s
    }
