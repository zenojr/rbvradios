...
error_reporting(0);
	...
	class Model{
		...
		public function __construct(){
			$this->db = new PDO('pgsql:host=postgresql02.rbvradios1.hospedagemdesites.ws;dbname=rbvradios13', 'rbvradios13', 'lambda6458');
			$this->db->exec("SET NAMES 'UTF8'");
		}

		//CONEXÃO PARA INSERÇÃO DE IMAGEM/AUDIO COMO OBJ OID COM PG_CONNECT
		public function connectPG(){
			return pg_connect("host=postgresql02.rbvradios1.hospedagemdesites.ws port=5432 dbname=rbvradios13 user=rbvradios13 password=lambda6458");
		}
